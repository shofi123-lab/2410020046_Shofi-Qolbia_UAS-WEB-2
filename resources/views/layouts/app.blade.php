...
<head>
    ...
    <title>@yield('title', 'Yoga From Home')</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom sticky-top py-3">
        <div class="container-fluid px-4">
            <a class="navbar-brand d-flex align-items-center gap-2 fw-bold text-gradient" href="{{ route('dashboard') }}" style="font-size: 1.4rem;">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto align-items-center">
                    @auth
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle fw-semibold px-3 py-2 rounded-3 bg-light border d-flex align-items-center gap-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa-solid fa-circle-user text-primary" style="font-size: 1.2rem;"></i> {{ Auth::user()->name }}
                            </a>
                    ...
                    @else
                        <li class="nav-item">
                            <a class="nav-link fw-semibold text-dark px-3 me-2" href="{{ route('login') }}">Masuk</a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-gradient-primary" href="{{ route('register') }}">Daftar Sekarang</a>
                        </li>
                    @endauth
                </ul>
            </div>
                ...
                <div class="col-md-3 col-lg-2 px-0 sidebar d-none d-md-block sticky-top" style="top: 86px; z-index: 100; height: calc(100vh - 86px);">
                    <div class="pt-4 d-flex flex-column h-100 justify-content-between pb-4">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item mb-2">
                                <a href="{{ route('yoga-classes.index') }}" class="nav-link {{ Request::is('yoga-classes*') ? 'active' : '' }}">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                    ...
                    <div class="d-md-none mb-3 card card-custom p-3">
                        <div class="d-flex justify-content-around text-center">
                            <a href="{{ route('dashboard') }}" class="text-decoration-none {{ Route::is('dashboard') ? 'text-primary fw-bold' : 'text-secondary' }}">
                                <i class="fa-solid fa-chart-pie d-block mb-1"></i> <small>Dashboard</small>
                            </a>
                            <a href="{{ route('instructors.index') }}" class="text-decoration-none {{ Request::is('instructors*') ? 'text-primary fw-bold' : 'text-secondary' }}">
                                <i class="fa-solid fa-user-tie d-block mb-1"></i> <small>Instruktur</small>
                            </a>
                            <a href="{{ route('yoga-classes.index') }}" class="text-decoration-none {{ Request::is('yoga-classes*') ? 'text-primary fw-bold' : 'text-secondary' }}">
                                <i class="fa-solid fa-circle-play d-block mb-1"></i> <small>Kelas</small>
                            </a>
                            <a href="{{ route('schedules.index') }}" class="text-decoration-none {{ Request::is('schedules*') ? 'text-primary fw-bold' : 'text-secondary' }}">
