<?php $__env->startSection('title', 'Masuk - Yoga From Home'); ?>
            ...
            <div class="card card-custom p-4 border-0">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('login')); ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control form-control-custom rounded-start-0" placeholder="nama@email.com" value="<?php echo e(old('email')); ?>" required autofocus>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="text-primary fw-semibold text-decoration-none"><small> Daftar Sekarang</small></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SOLIT\Documents\2410020046_Shofi Qolbia_UAS_WEB_2\resources\views/auth/login.blade.php ENDPATH**/ ?>