<?php $__env->startSection('title', 'Dashboard - Yoga From Home'); ?>
            ...
            <div class="p-5 rounded-4 card-custom border-0" style="background: linear-gradient(135deg, rgba(124, 58, 237, 0.08) 0%, rgba(2, 132, 199, 0.08) 100%);">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <h1 class="fw-extrabold text-indigo-900 display-5 mb-2">Halo, <?php echo e(Auth::user()->name); ?>!</h1>
            ...
            <div class="card card-custom border-0 p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($totals['classes']); ?></h2>
                    </div>
                ...
                <div class="mt-3 pt-2 border-top">
                    <a href="<?php echo e(route('yoga-classes.index')); ?>" class="text-decoration-none text-primary fw-semibold d-flex align-items-center gap-1 hover-lift" style="font-size: 0.85rem;">
            ...
            <div class="card card-custom border-0 p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($totals['instructors']); ?></h2>
                    </div>
                ...
                <div class="mt-3 pt-2 border-top">
                    <a href="<?php echo e(route('instructors.index')); ?>" class="text-decoration-none text-info fw-semibold d-flex align-items-center gap-1 hover-lift" style="font-size: 0.85rem;">
            ...
            <div class="card card-custom border-0 p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($totals['schedules']); ?></h2>
                    </div>
                ...
                <div class="mt-3 pt-2 border-top">
                    <a href="<?php echo e(route('schedules.index')); ?>" class="text-decoration-none text-primary fw-semibold d-flex align-items-center gap-1 hover-lift" style="font-size: 0.85rem;">
            ...
            <div class="card card-custom border-0 p-3">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($totals['active_schedules']); ?></h2>
                    </div>
        ...
        <div class="col-lg-6">
            <div class="card card-custom border-0 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('yoga-classes.index')); ?>" class="btn btn-sm btn-light border rounded-3 fw-semibold">Lihat Semua</a>
                </div>
                    ...
                    <table class="table table-hover table-custom mb-0">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recentClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($class->nama_kelas); ?></strong></td>
                                    <td>
                                        <span class="badge badge-<?php echo e(strtolower($class->level)); ?>"><?php echo e($class->level); ?></span>
                                    </td>
                                    <td><?php echo e($class->instructor->nama ?? 'Tidak Ada'); ?></td>
                                </tr>
        ...
        <div class="col-lg-6">
            <div class="card card-custom border-0 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo e(route('schedules.index')); ?>" class="btn btn-sm btn-light border rounded-3 fw-semibold">Lihat Semua</a>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover table-custom mb-0">
                        <thead>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $upcomingSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sched): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <span class="text-primary fw-semibold"><i class="fa-regular fa-clock me-1"></i> <?php echo e($sched->hari); ?>, <?php echo e($sched->jam); ?></span>
                                    </td>
                                    <td><?php echo e($sched->yogaClass->nama_kelas ?? 'Tidak Ada'); ?></td>
                                    <td>
                                        <small class="text-muted"><i class="fa-solid fa-user-tie me-1"></i> <?php echo e($sched->yogaClass->instructor->nama ?? '-'); ?></small>
                                    </td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SOLIT\Documents\2410020046_Shofi Qolbia_UAS_WEB_2\resources\views/dashboard.blade.php ENDPATH**/ ?>