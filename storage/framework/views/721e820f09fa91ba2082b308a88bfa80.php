<?php $__env->startSection('title', 'Tambah Instruktur - Yoga From Home'); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Contoh: Budi Santoso" value="<?php echo e(old('nama')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" type="radio" name="jenis_kelamin" id="jk_l" value="Laki-laki" <?php echo e(old('jenis_kelamin') == 'Laki-laki' ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>" type="radio" name="jenis_kelamin" id="jk_p" value="Perempuan" <?php echo e(old('jenis_kelamin') == 'Perempuan' ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?>" placeholder="Contoh: 5" value="<?php echo e(old('pengalaman')); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" placeholder="Contoh: 081234567890" value="<?php echo e(old('nomor_hp')); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SOLIT\Documents\2410020046_Shofi Qolbia_UAS_WEB_2\resources\views/instructors/create.blade.php ENDPATH**/ ?>